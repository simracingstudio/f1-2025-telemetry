...
* [ ] Search [existing issues](https://gitlab.com/gparent/f1-2021-telemetry/-/issues?scope=all) for keywords related to the feature
* [ ] Read the [latest documentation](https://f1-2021-telemetry.readthedocs.io/en/latest/) to make sure it doesn't exist already
