...
.. code-block:: console
   ...
   usage: f1-2023-telemetry-recorder [-h] [-p PORT] [-i INTERVAL]

   Record F1 2023 telemetry data to SQLite3 files.
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
f1-2023-telemetry-player script
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. code-block:: console

   usage: f1-2023-telemetry-player [-h] [-r REALTIME_FACTOR] [-d DESTINATION] [-p PORT] filename

   Replay an F1 2023 session as UDP packets.
...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
f1-2023-telemetry-monitor script
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

.. code-block:: console

   usage: f1-2023-telemetry-monitor [-h] [-p PORT]
